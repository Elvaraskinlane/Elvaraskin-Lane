    ...
    <main className="w-full bg-background animate-fade-in pt-32 pb-24">
      <div className="max-w-3xl mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <header className="text-center mb-16">
          <h1 className="font-headline-lg text-headline-lg text-on-background mb-4">Terms of Service</h1>
        ...
        <div className="flex flex-col gap-12">
          ...
          <section>
            <h2 className="font-headline-sm text-headline-sm text-on-background mb-4 border-b border-outline-variant/30 pb-2">1. Overview</h2>
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed mb-4">
              This website is operated by Elvara Skinlane. Throughout the site, the terms "we", "us" and "our" refer to Elvara Skinlane. We offer this website, including all information, tools, and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
            </p>
          ...
          <section>
            <h2 className="font-headline-sm text-headline-sm text-on-background mb-4 border-b border-outline-variant/30 pb-2">2. General Conditions</h2>
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed mb-4">
          ...
          <section>
            <h2 className="font-headline-sm text-headline-sm text-on-background mb-4 border-b border-outline-variant/30 pb-2">3. Products or Services</h2>
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed mb-4">
          ...
          <section>
            <h2 className="font-headline-sm text-headline-sm text-on-background mb-4 border-b border-outline-variant/30 pb-2">4. Accuracy of Billing and Account Information</h2>
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed mb-4">
