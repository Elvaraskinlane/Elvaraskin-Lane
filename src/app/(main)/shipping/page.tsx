        ...
        <div className="flex flex-col gap-12">
          ...
          <section>
            ...
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed mb-4">
              At Elvara Skinlane, we believe the luxury experience extends to how your products are delivered. We are pleased to offer complimentary standard shipping on all orders over ₦150,000 nationwide across Nigeria.
            </p>
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
              For orders under ₦150,000, a flat shipping rate of ₦3,000 will be applied at checkout. Standard shipping typically takes 3-5 business days. We also offer expedited 2-day shipping for ₦10,000 if you need your essentials sooner.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed mb-4">
              All orders are processed and shipped from our fulfillment center within 1-2 business days. Orders placed after 12 PM WAT on Fridays, or on weekends and public holidays, will be processed the following business day.
            </p>
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
          ...
          <section>
            ...
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed mb-4">
              Your satisfaction is our highest priority. If you are not completely satisfied with your purchase, you may return it within 14 days of the delivery date for a full refund or exchange.
            </p>
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed mb-4">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
              To initiate a return, simply contact our concierge team at <strong>elvaraskinlane@gmail.com</strong> with your order number. We will provide you with return instructions and details.
            </p>
          </section>
