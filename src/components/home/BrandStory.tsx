    ...
    <section className="py-24 md:py-32 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
        ...
        <div className="relative h-[600px] lg:h-[800px] w-full lg:col-span-7">
          ...
          <div className="absolute bottom-0 right-0 w-[60%] h-[55%] z-20 bg-surface border-4 border-background translate-y-8 -translate-x-4 lg:translate-x-8">
            <Image 
        ...
        <div className="flex flex-col justify-center max-w-lg lg:col-span-5">
          ...
          <Link 
            href="/shop"
            className="inline-flex items-center text-primary font-label-md text-label-md border-b border-primary pb-1 w-max hover:text-on-background hover:border-on-background transition-colors duration-300 uppercase tracking-widest"
          >
            Shop The Collection
          </Link>
        </div>
