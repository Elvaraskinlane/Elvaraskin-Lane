import { Verified, Stars, LocalShipping } from '@material-symbols-svg/react';
      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        <div className="flex flex-col md:flex-row justify-center items-center md:space-x-16 space-y-4 md:space-y-0 text-center">
          ...
          <div className="flex items-center space-x-3">
            <Verified className="text-on-surface-variant" />
          ...
          <div className="flex items-center space-x-3">
            <Stars className="text-on-surface-variant" />
          ...
          <div className="flex items-center space-x-3">
            <LocalShipping className="text-on-surface-variant" />
