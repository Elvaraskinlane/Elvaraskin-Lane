import { Eco, WaterDrop, Recycling } from '@material-symbols-svg/react';
      ...
      <div className="w-full max-w-[1280px] mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-surface p-10 rounded-sm border border-secondary-container shadow-[0_30px_60px_-15px_rgba(44,44,44,0.04)] hover:-translate-y-1 transition-transform duration-300">
            <Eco className="text-secondary mb-6 text-3xl" style={{ fontVariationSettings: "'wght' 200" }} />
          ...
          {/* Feature 2 */}
          <div className="bg-surface p-10 rounded-sm border border-secondary-container shadow-[0_30px_60px_-15px_rgba(44,44,44,0.04)] hover:-translate-y-1 transition-transform duration-300">
            <WaterDrop className="text-secondary mb-6 text-3xl" style={{ fontVariationSettings: "'wght' 200" }} />
          ...
          {/* Feature 3 */}
          <div className="bg-surface p-10 rounded-sm border border-secondary-container shadow-[0_30px_60px_-15px_rgba(44,44,44,0.04)] hover:-translate-y-1 transition-transform duration-300">
            <Recycling className="text-secondary mb-6 text-3xl" style={{ fontVariationSettings: "'wght' 200" }} />
