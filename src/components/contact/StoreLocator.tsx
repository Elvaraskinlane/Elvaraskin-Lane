...
import { LocationOn, ArrowForward } from '@material-symbols-svg/react';
  ...
  return (
    <section className="w-full bg-surface-container-low py-20 px-margin-mobile md:px-margin-desktop border-y border-secondary-fixed-dim/30 mt-16">
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
        <LocationOn className="text-primary mb-4" style={{ fontSize: '32px', fontVariationSettings: "'wght' 300" }} />
